...
def by_address(keywords):
    ...
    output_file = f"{save_file}/AD-{keywords[0]}.xlsx"
...
keywords = "Stainless Steel Shoe Rack"
by_iteam(keywords)

# keywords = ["Manipur","UKHRUL","IMPHAL WEST","BISHNUPUR","CHANDEL","CHURACHANDPUR","IMPHAL","SENAPATI","TAMENGLONG","THOUBAL","UKHRUL","Arunachal Pradesh","ANANTHAPUR","CHITTOOR","CUDDAPAH","GODAVARI","GUNTUR","KRISHNA","KURNOOL","NELLORE","PRAKASAM","SRIKAKULAM","VISAKHAPATNAM","VIZIANAGARAM","Assam","BARPETA","BONGAIGAON","CACHAR","DARRANG","DHEMAJI","DHUBRI","DIBRUGARH","GOALPARA","GOLAGHAT","HAILAKANDI","JORHAT","KAMRUP","KARBI ANGLONG","KARIMGANJ","KOKRAJHAR","LAKHIMPUR","MARIGAON","NAGAON","NALBARI","CACHAR HILLS","SIVASAGAR","SONITPUR","TINSUKIA","Meghalaya","GARO HILLS","KHASI HILLS","JAINTIA HILLS","RI BHOI","Nagaland","DIMAPUR","KIPHIRE","KOHIMA","LONGLENG","MOKOKCHUNG","MON","PEREN","PHEK","TIJENSANG","WOKHA","ZUNHEBOTTO","Sikkim","Tripura","DHALAI","MIZORAM","AIZAWL","CHAMPHAI","KOLASIB","LAWNGTLAI","LUNGLEI","MAMMIT","SAIHA","SERCHHIP"]
# by_address(keywords)
    
# keywords = ["Meghalaya","GARO HILLS","KHASI HILLS","JAINTIA HILLS","RI BHOI",]
# by_address(keywords)
