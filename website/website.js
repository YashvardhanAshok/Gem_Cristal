 function checkbox2(){
    ...
    if (selectedItems.length === checkboxes.length - 1) {
        ...
        if (document.getElementById("web1").checked==true){dropdownToggle.textContent = document.getElementById('web1').value;}
        else if (document.getElementById("web2").checked==true){dropdownToggle.textContent = document.getElementById('web2').value;}
        else if (document.getElementById("web3").checked==true){dropdownToggle.textContent = document.getElementById('web3').value;}
        else if (document.getElementById("web4").checked==true){dropdownToggle.textContent = document.getElementById('web4').value;}
        else if (document.getElementById("web5").checked==true){dropdownToggle.textContent = document.getElementById('web5').value;}
        else if (document.getElementById("web6").checked==true){dropdownToggle.textContent = document.getElementById('web6').value;}
        else if (document.getElementById("web7").checked==true){dropdownToggle.textContent = document.getElementById('web7').value;}
        else if (document.getElementById("web8").checked==true){dropdownToggle.textContent = document.getElementById('web8').value;}
        else if (document.getElementById("web9").checked==true){dropdownToggle.textContent = document.getElementById('web9').value;}
        else if (document.getElementById("web10").checked==true){dropdownToggle.textContent = document.getElementById('web10').value;}
        else if (document.getElementById("web11").checked==true){dropdownToggle.textContent = document.getElementById('web11').value;}
        else if (document.getElementById("web12").checked==true){dropdownToggle.textContent = document.getElementById('web12').value;}
    ...
    fetch(elementlink)
        ...
        .then(data => {
            ...
            data.forEach(post => {
                ...
                if (closingDate > currentDate || closingDate === currentDate) {
                    ...
                    `;
                    //   <div class="card-tile"><p class="card-tile_date">${post.dateOfSearch}</p><p class="card-tile_date2">${post.elementPut} - <h6 class="h6card-tile">${post.bid_title}</h6></p>${modifiedTitle}</div>
...
function setArrayCookie(array) {document.cookie = `selectedElements=${JSON.stringify(array)}; expires=Thu, 01 Jan 2030 00:00:00 UTC; path=/;`;}
