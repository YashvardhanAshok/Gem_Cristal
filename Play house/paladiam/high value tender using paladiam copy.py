...
def exl(existing_data,csv_path):
    ...
    output_file = r"C:\vs_code\TenderHunter2.1.3\Exported_Tender_Data.xlsx"
    ...
    print(unique_id)
    merged_pdf = f"C:\vs_code\TenderHunter2.1.3\Play house\paladiam\result{tender_id}_{ognisation}.pdf" 
    print("\n","\n","\n","\n","\n","\n","\n","\n","\n",output_file,"\n",your_pdf,"\n",merged_pdf)
